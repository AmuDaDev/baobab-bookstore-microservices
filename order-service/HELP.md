...
* The original package name 'com.baobab.bookstore.order-service' is invalid and this project uses 'com.baobab.bookstore.order_service' instead.
...
* [Flyway Migration](https://docs.spring.io/spring-boot/docs/3.2.9/reference/htmlsingle/index.html#howto.data-initialization.migration-tool.flyway)
